...
export TRAINING_FOLDS="(0, 1,2,3,4,5)"
export VALIDATION_FOLDS="(6,)"
python train.py


export TRAINING_FOLDS="(0, 1,2,3,4,6)"
export VALIDATION_FOLDS="(5,)"
python train.py



export TRAINING_FOLDS="(0,1,2,3,5,6)"
export VALIDATION_FOLDS="(4,)"
python train.py


export TRAINING_FOLDS="(0,1,2,4,5,6)"
export VALIDATION_FOLDS="(3,)"
python train.py


export TRAINING_FOLDS="(0,1,3,4,5,6)"
export VALIDATION_FOLDS="(2,)"
python train.py


export TRAINING_FOLDS="(0,2,3,4,5,6)"
export VALIDATION_FOLDS="(1,)"
python train.py


export TRAINING_FOLDS="(1,2,3,4,5,6)"
